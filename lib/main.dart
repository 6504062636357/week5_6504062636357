...
import 'package:untitled2/about_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        appBarTheme: const AppBarTheme(color: Color.fromARGB(255, 150, 216, 241)),
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color.fromARGB(255, 196, 222, 235),
        ),
        useMaterial3: true,
      ),
      home: WelcomePage(),
